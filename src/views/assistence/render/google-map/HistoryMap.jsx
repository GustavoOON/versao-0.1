...
const FollowMap = (props) => {
    ...
    function CarregaRotaPrestador() {
        ...
        let request = {
            origin: {
                lat: props.history.addressPrestador.lat,
                lng: props.history.addressPrestador.lng,
            },
            destination: {
                lat: props.history.adressDestino.lat,
                lng: props.history.adressDestino.lng,
            },
            waypoints: [
                {
                    location: {
                        lat: props.history.adressOcorrency.lat,
                        lng: props.history.adressOcorrency.lng,
                    },
                    stopover: true,
                },
    ...
    return isLoaded ? (
        <div className="container-map-history">
            <GoogleMap
