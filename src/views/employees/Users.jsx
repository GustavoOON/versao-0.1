...
import Association from './render/Association';
...
const Clients = () => {
    ...
    function searchMail(e) {
        if (e.key === 'Enter' || e.type === 'click') {
            ...
            axios
                .get(
                    `${UrlDomain}/employees/email/${busca2.toLocaleLowerCase()}`,
                    config
                )
                .then((response) => {
                        ...
                        <CNavbar expand="lg" className="menuUser">
                            <CContainer fluid>
                                ...
                                >
                                    ...
                                    <CForm className="d-flex">
                                        <div className="input-icon-global d-flex w-100">
                                            <i className="icon-search-global">
                                                <BiSearchAlt2 color="#6D6D6D" />
                                            </i>
                                            <CFormInput
                                                type="text"
